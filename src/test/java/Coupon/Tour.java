...
public class Tour {
	...
	public void bookATour(WebDriver driver) {
	    ...
	    WebElement tourMenuOption = driver.findElement(By.xpath("/html/body/nav[1]/div/div/div/ul/li[4]/a"));	
		//Click on Hotel option from the menu
		tourMenuOption.click();
		
		//Wait until the list of tours is loaded
		...
		WebElement detailsButton = driver.findElement(By.xpath("//*[@id=\"body-section\"]/div[7]/div[2]/div/table/tbody/tr[1]/td/div[2]/div/div[6]/a/button"));
		detailsButton.click();
		...
		wait3.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("/html/body/div[5]/div[2]/div[2]/div/form/div[4]/button"))));
		WebElement bookNowButton = driver.findElement(By.xpath("/html/body/div[5]/div[2]/div[2]/div/form/div[4]/button"));
